    ...
    return(
        ...
        <div className="page-social">
            <div className="social-header">
                <div className="social-header-text1">햇살주간보호센터 어르신들의 따뜻한 순간을 사진으로 전해드립니다.
                <br/>햇살주간보호센터의 인스타그램은 어르신들의 소소한 일상과 행복한 순간들을 기록하는 공간입니다.
            ...
            <div className="social-footer">
                ...
                <div className="social-header-text1">오늘도 어르신들의 웃음으로 하루가 반짝였습니다.
